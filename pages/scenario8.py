...
def generate_response(prompt):
    """
    Function to generate a short, high accuracy response with source and review.
    Args:
        prompt (str): The user's input prompt.
    Returns:
        str: The assistant's response.
    """
    # Short, High accuracy, With source, With review
...
def main():
    st.title("Snail Sleep Duration Chat - Scenario 8")
    st.caption("Short Response | High Accuracy | With Source | With Review")
    ...
    if prompt := st.chat_input("How long do snails sleep?"):
        ...
        with st.chat_message("assistant"):
            ...
            # Show source and review information
            st.info("Source: Journal of Molluscan Studies (2019)")
            st.success(
                "This information has been peer-reviewed by malacologists")
